...
class ZakljucneTab extends StatelessWidget{
  final List<Predmet> predmeti;
  const ZakljucneTab({super.key, required this.predmeti});
  @override
  Widget build(BuildContext context) {
    final prosjek = izracunajKrajGodine(predmeti);
    return Column(
      children: [
        Expanded( // <<< Ovo rješava sve
          child: PredmetiLista(
            prikazZa: 'zakljucna',
            predmeti: predmeti,
          ),
